...
Development happens on [GitHub](https://github.com/vim/vim) ⭐ 40,887 | 🐛 1,625 | 🌐 Vim Script | 📅 2026-09-10, discussions on the
...
Or quickly open a cheatsheet from within Vim: [vim-cheat40](https://github.com/lifepillar/vim-cheat40) ⚠️ Archived.
...
[FastFold](https://github.com/Konfekt/FastFold) ⭐ 700 | 🐛 13 | 🌐 Vim Script | 📅 2025-06-04, which prevents Vim from
...
[Pathogen](https://github.com/tpope/vim-pathogen) ⭐ 12,120 | 🐛 27 | 🌐 Vim Script | 📅 2022-08-24 was the first popular tool for
...
[multiple-cursors](https://github.com/terryma/vim-multiple-cursors) ⭐ 7,949 | 🐛 1 | 🌐 Vim script | 📅 2020-07-30.
...
[tmux](https://github.com/tmux/tmux/wiki) ⭐ 49,172 | 🐛 31 | 🌐 C | 📅 2026-09-10 which basically sits in between the
...
An alternative would be using [caps2esc](https://github.com/oblitum/caps2esc) ⚠️ Archived or
...
| `:set foldmethod=syntax` | If the syntax file is slow already, this makes it even worse.                                                     | `:set foldmethod=manual`, `:set foldmethod=marker` or [FastFold](https://github.com/Konfekt/FastFold) ⭐ 700 \| 🐛 13 \| 🌐 Vim Script \| 📅 2025-06-04 |
...
[bracketed-paste](https://github.com/ConradIrwin/vim-bracketed-paste) ⭐ 493 | 🐛 14 | 🌐 Vim Script | 📅 2024-03-06.
...
[8.0.360](https://github.com/vim/vim/commit/b544f3c81f1e6a50322855681ac266ffaa8e313c) ⭐ 40,887 | 🐛 1,625 | 🌐 Vim Script | 📅 2026-09-10
